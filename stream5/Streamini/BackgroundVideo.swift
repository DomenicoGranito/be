...
enum BackgroundVideoErrors: Swift.Error
{
    case invalidVideo
}
...
class BackgroundVideo
{
    ...
    func setUpBackground(){
            ...
            NotificationCenter.default
                .addObserver(self,
                             selector:#selector(BackgroundVideo.loopVideo),
                             name: NSNotification.Name.AVPlayerItemDidPlayToEndTime,
                             object: nil)
            // call the background video again if your application goes to background and foreground again
            NotificationCenter.default.addObserver(self, selector:#selector(BackgroundVideo.loopVideo), name:NSNotification.Name.UIApplicationWillEnterForeground , object: nil)
        hasBeenUsed = true

//
//  ARNVTransitionAnimator.swift
//  ARNVTransitionAnimator
//
...
public enum ARNVTransitionAnimatorDirection: Int {
    case top
    case bottom
    case left
    case right
...
public enum ARNVTransitionAnimatorOperation: Int {
    case none
    case push
    case pop
    case present
...
open class ARNVTransitionAnimator: UIPercentDrivenInteractiveTransition {
    ...
    open var direction : ARNVTransitionAnimatorDirection = .bottom
    open var contentScrollView : UIScrollView?
    open var interactiveType : ARNVTransitionAnimatorOperation = .none {
        didSet {
    ...
    fileprivate(set) var operationType : ARNVTransitionAnimatorOperation
    ...
    public init(operationType: ARNVTransitionAnimatorOperation, fromVC: UIViewController, toVC: UIViewController) {
    ...
    fileprivate func registerPanGesture() {
        ...
        self.gesture = UIPanGestureRecognizer(target: self, action: #selector(ARNVTransitionAnimator.handlePan(_:)))
...
extension ARNVTransitionAnimator {
...
extension ARNVTransitionAnimator: UIViewControllerAnimatedTransitioning {
...
extension ARNVTransitionAnimator: UIViewControllerTransitioningDelegate {
...
extension ARNVTransitionAnimator: UIGestureRecognizerDelegate {

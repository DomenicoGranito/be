...
class CategoriesViewController: BaseViewController, PlayerViewControllerDelegate
{
    ...
    func tableView(_ tableView:UITableView, cellForRowAtIndexPath indexPath:IndexPath)->UITableViewCell
    {
        ...
        cell.userImageView.layer.shadowColor=UIColor.white.cgColor
        cell.userImageView.layer.shadowRadius=2
        cell.userImageView.layer.shadowOffset=CGSize(width:0, height:0)
